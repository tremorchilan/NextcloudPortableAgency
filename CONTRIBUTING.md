...
```bash
# 1. Fork on GitHub: https://github.com/tremorchilan/NextcloudPortableAgency → Fork
# 2. Clone your fork
...
template. Including the commit SHA, the runtime (your host / Vercel /
...
- Rebrand. This fork is already re-branded for portable-agency use
  (name, favicon, and marketing URLs swapped). If you publish your own
  fork, keep the `NEXT_PUBLIC_BRAND_*` env vars in mind and swap any
  remaining upstream references for your own before going live.

...
- [GitHub Security Advisories](https://github.com/tremorchilan/NextcloudPortableAgency/security/advisories/new)
  (preferred — keeps the disclosure, fix, and CVE all in one place).
- Email: `security@portable-agency.example` with `[CRM security]` in the subject.
...
In scope:
- Anything in this repository (`tremorchilan/NextcloudPortableAgency`), including webhook and auth

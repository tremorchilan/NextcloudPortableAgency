...
const nextConfig: NextConfig = {
   ...
   * app can run from a minimal Docker image without the full
   * `node_modules` tree. Required by the provided `Dockerfile`.
   */
  output: "standalone",
   ...
   *
   * Why this exists:
   *   Some CDNs apply `s-maxage=31536000` (1 year) to

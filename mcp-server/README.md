# Portable Agency CRM MCP server

A [Model Context Protocol](https://modelcontextprotocol.io) server for
**[Portable Agency CRM](https://github.com/tremorchilan/NextcloudPortableAgency)**
(a fork of [wacrm](https://github.com/ArnasDon/wacrm)) — the self-hostable
...
It's a thin wrapper over your instance's public [`/api/v1`](../docs/public-api.md)
